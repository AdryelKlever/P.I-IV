...
--
-- Host: localhost    Database: papelbd
-- ------------------------------------------------------
...
CREATE TABLE `valor` (
  ...
  `alturaMedia` float NOT NULL,
  `montagemLateral` varchar(45) NOT NULL,
  `etiquetasUnidade` varchar(45) NOT NULL,
...
-- Dump completed on 2017-11-06 19:56:07
